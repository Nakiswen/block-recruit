...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\workspace\\block-recruit\\apps\\api\\src\\prisma\\web3jobs",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\workspace\\block-recruit\\prisma\\web3jobs.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/api/src/prisma/web3jobs",
    "api/src/prisma/web3jobs",
  ]
...
path.join(process.cwd(), "apps/api/src/prisma/web3jobs/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-darwin-arm64.dylib.node");
path.join(process.cwd(), "apps/api/src/prisma/web3jobs/libquery_engine-darwin-arm64.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "apps/api/src/prisma/web3jobs/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/api/src/prisma/web3jobs/schema.prisma")
